...
if __name__ == '__main__':
	...
	gripper = actionlib.SimpleActionClient('gripper_controller/graipper_action',GripperCommandAction)
	...
	while not rospy.is_shutdown():
		...
		try:
			...
			(item_translation, item_orientation) = tf_listener.lookupTransform('/base_link',item_frame,t) #8
		...
		gipper.wait_for_result(rospy.Duration(2.0))
